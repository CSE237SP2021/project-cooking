...
public class RecipeOutputterTest {
	...
	public void testSelectRecipe() {
		...
		assertTrue("Name of the second file is testfile_2.html", availableRecipes[1].equals("testfile_2.html"));
		assertTrue("Name of the third file is testfile_3.html", availableRecipes[2].equals("testfile_3.html"));
